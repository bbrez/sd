...
function update() {
    if (getUser.value == null) return;
    if (new_nick.value != getUser.value.chats[props.currentChat].nickname ||
        new_color.value != getUser.value.chats[props.currentChat].color) {
        update_user();
    }

    if (new_chat_name.value != getUser.value.chats[props.currentChat].chat.name ||
        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <div class="field is-grouped">
                    ...
                    <div class="control"><button class="button is-light is-warning"
                            @click="$emit('close')">Cancelar</button></div>
